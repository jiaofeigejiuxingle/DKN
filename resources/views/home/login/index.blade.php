    ...
    <div class="nreg_box mt15 clearfix" style="left: 50%;margin-left: 115px;position: absolute;top: 0;width: 378px;z-index: 1;">
        <div class="nreg_left fr">
            <ul class="tab_sig_reg clearfix">
                ...
                <li class="tab_reg"><a href="javascript:register();">注册</a></li>
            </ul>
            <div class="nreg_form">
                <form sid="loginform" method="post" action="/Home/logTodo">
                    ...
                    <dl class="nreg_item clearfix">
                        <dd>
                            <div class="nreg_input_bg">
                                ...
                                <input type="text" name="uname" placeholder="账号" id="email_" class="nreg_input" maxlength="50" value=""/>
                            </div>
                        </dd>
