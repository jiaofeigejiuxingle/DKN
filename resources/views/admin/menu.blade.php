...
background='/images/adminmenu_bg.jpg' border=0>
  <TR>
    <TD vAlign=top align=middle>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        ...
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background='/images/adminmenu_bt.jpg'><A 
      ...
      width=150 border=0>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="/images/adminmenu_icon.gif" width=9></TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background='/images/admin/menu_bt.jpg'><A 
            ...
            href="javascript:void(0);">分组管理</A></TD></TR>
        <TR height=4>
          <TD></TD></TR></TABLE>
      ...
      width=150 border=0>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="/images/admin/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="{{ url('/Admin/group') }}" 
            target=main>分组列表</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="/images/admin/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="{{ url('/Admin/group/create') }}" 
            target=main>添加分组</A></TD></TR>
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background='/images/admin/menu_bt.jpg'><A 
      ...
      width=150 border=0>
        <TR height=20>
          ...
          <TD><A class=menuChild 
            href="{{url('/Admin/rule')}}" 
            target=main>所有权限</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="/images/admin/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="{{url('/Admin/rule/create')}}" 
            target=main>添加权限</A></TD></TR>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=150 border=0>
        ...
        <TR height=22>
          <TD style="PADDING-LEFT: 30px" background='/images/admin/menu_bt.jpg'><A 
            ...
            href="javascript:void(0);">商品详细信息</A></TD></TR>
        <TR height=4>
          <TD></TD></TR></TABLE>
      ...
      width=150 border=0>
        ...
        <TR height=20>
          ...
          <TD><A class=menuChild 
            ...
            target=main>详细列表</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="/images/admin/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
            href="{{url('/Admin/detail/create')}}" 
            target=main>添加详细信息</A></TD></TR>
        <TR height=20>
          <TD align=middle width=30><IMG height=9 
            src="/images/admin/menu_icon.gif" width=9></TD>
          <TD><A class=menuChild 
